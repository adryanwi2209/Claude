"""
Backtest: Complete Trading Strategy on MSFT 1h Data
=====================================================
Reads MSFT_1h_730d.csv and runs the full optimized technical analysis
...
if __name__ == "__main__":
    filepath = "Market Data/MSFT_1h_730d.csv"
    ...
    # ── Print Report ──
    print("=" * 64)
    print("     MSFT BACKTEST RESULTS — Complete Trading Strategy")
    print("=" * 64)
    ...
    print()
    print(f"  MSFT Price       : ${metrics['first_price']:.2f} → ${metrics['last_price']:.2f}")
    print("=" * 64)

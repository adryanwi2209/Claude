"""
Backtest: Complete Trading Strategy on GOOGL 1h Data
=====================================================
Reads GOOGL_1h_730d.csv and runs the full optimized technical analysis
strategy with parameter sweep and performance metrics.
"""
...
if __name__ == "__main__":
    filepath = "Market Data/GOOGL_1h_730d.csv"
    ...
    # ── Print Report ──
    print("=" * 64)
    print("     GOOGL BACKTEST RESULTS — Complete Trading Strategy")
    print("=" * 64)
    ...
    print()
    print(f"  GOOGL Price       : ${metrics['first_price']:.2f} → ${metrics['last_price']:.2f}")
    print("=" * 64)
